...
HISTORICAL_HARNESS_PROTOCOL_VERSION = "m1-dev-harness-v13"
F2_HARNESS_PROTOCOL_VERSION = "m1-dev-harness-v14"
HARNESS_PROTOCOL_VERSION = "m1-dev-harness-v15"
VERIFIABLE_HARNESS_PROTOCOL_VERSIONS = frozenset(
    {HISTORICAL_HARNESS_PROTOCOL_VERSION, F2_HARNESS_PROTOCOL_VERSION, HARNESS_PROTOCOL_VERSION}
)
